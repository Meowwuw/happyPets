        ...
        if (isValid && value) {
            switch (fieldName) {
                case 'correo':
                    ...
                    if (domain && !commonDomains.includes(domain) && !domain.includes('.pe') && !domain.includes('.com')) {
                        // Advertencia, pero no error
                        showFieldWarning(field, 'Verifica que el dominio del correo sea correcto');
                    }
                    break;
                ...
                case 'telefono':
                    ...
                    if (cleanPhone.length === 9 && !cleanPhone.startsWith('9')) {
                        showFieldWarning(field, 'Los teléfonos móviles en Perú suelen empezar con 9');
                    }
                    break;
            }
        }
